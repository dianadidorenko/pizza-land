...
const PizzaDetails = ({ pizza, setModal }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:gap-x-8 h-full md:p-0 ">
      ...
      <div className="flex flex-col flex-1">
        <div className="flex-1 p-2 text-center lg:text-left">
          <div
            className="bg-white flex-1 overflow-y-scroll h-[46vh]
          scrollbar-thin scrollbar-thumb-gray-500 pr-2"
          >
